 ...
 * Requires state OBJECT_VALUE
 */
qson_result_t qson_deserialize_object_entry_value_string_auto(qson_deserialize_ctx_t ctx, char **value, size_t *value_length, bool *has_next);
...
/*
 * Skips object at current index in context
 * Ignores state
 */
qson_result_t qson_deserialize_object_skip(qson_deserialize_ctx_t ctx);
